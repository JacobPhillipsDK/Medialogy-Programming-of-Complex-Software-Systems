...
class PlayerRole(Player):
    def __init__(self, new_name="Default", new_lane="Default",new_age = 0, new_team="None", new_motivation=0, new_experience = 0, new_reaction = 0):
        super(Player, self).__init__(new_name, new_lane, new_age)
