...
players2 = []
players1.append(GS.PlayerRole("Poul", "mid", 5,7,6))
players1.append(GS.PlayerRole("Frank", "supp", 7,8,9))
players1.append(GS.PlayerRole("Erik", "adc", 5,8,9))
players1.append(GS.PlayerRole("Lars", "jung", 10,8,9))
players1.append(GS.PlayerRole("george", "top", 6,2,9))
